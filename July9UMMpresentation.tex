...
{\it Bad directions from Science Building to Student Center:}

{Go outside. Look for the building next to the Library.}

{\it Good directions from Science Building to Student Center:}

{Starting from the Science Building, go outside a North exit. On the East side of the Library, between the Mall and Library, there is another one-story building. That's the Student Center!}
\end{frame}
...
\begin{itemize}
\item to test:
\item The purpose of testing is to make sure that your code works.
\item Oftentimes, code is so complex that testing is the only way to make sense of it and make sure all the pieces are working correctly.
\item Automated testing has many benefits, such as:
\begin{itemize}
\item quick testing
\item quick fixing
\end{itemize}
...
\begin{itemize}
\item to refactor: to change the structure of code to make it clearer or more efficient  without changing functionality
